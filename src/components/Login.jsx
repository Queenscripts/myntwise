...
export default function Login() {
  return (
    <div class="flex flex-col p-4">
      <div style={{height:"60vh"}} class="flex h-full items-center justify-center py-12 px-4 sm:px-6 lg:px-8">
        <div class="max-w-md w-full space-y-8">
          <div>
            <img
              class="mx-auto h-12 w-auto"
              src="static/favicon_io/favicon-32x32.png"
              alt="Workflow"
            />
          ...
          <form class="mt-8 space-y-6" action="/login" method="POST">
            ...
            <div class="rounded-md shadow-sm -space-y-px">
              <div>
                ...
                {/* {% if email %} */}
                {/* <input id="email-address" value={{email.email}} name="email" type="email" autocomplete="email" required class="appearance-none rounded-none relative block w-full px-3 py-2 border border-gray-300 placeholder-gray-500 text-gray-900 rounded-t-md focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 focus:z-10 sm:text-sm" placeholder="Email address"/> */}
                {/* {% else %} */}
                <input
                  id="email-address"
                  name="email"
          ...
          <div align="center">
            <a href="/google" class="login-btn" style={{textDecoration:"none"}}>
      ...
      <img src="static/img/arabica-finance.png" style={{position: "absolute",float: "left",top: "100px",right: "538px",zIndex: -1,opacity: .3}}/>
