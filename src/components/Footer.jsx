...
export default function Footer(props){
    return(
        <footer style={{position:"relative", top:"42vh"}} class="text-center bg-gray-900 text-white">
      ...
      */}
       ...
       */}
          ...
          <div class="grid lg:grid-cols-4 md:grid-cols-2">
            <div class="mb-6">
              <h5 class="uppercase font-bold mb-2.5">Budgets</h5>
      
              <ul class="list-none mb-0">
                <li>
                  <a href="/budgets" class="text-white">Budget Page</a>
                </li>
                {/* <li>
            ...
            <div class="mb-6">
              <h5 class="uppercase font-bold mb-2.5">Dashboard</h5>
      
              <ul class="list-none mb-0 left-align">
                <li>
                  <a href="/dashboard#transactions" class="text-white">Transationcs</a>
                </li>
                <li>
                  <a href="/dashboard#advice" class="text-white">Shopping Advice</a>
                </li>
                <li>
                  <a href="/dashboard#charts" class="text-white">My Charts</a>
                </li>
